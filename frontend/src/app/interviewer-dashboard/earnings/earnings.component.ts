          ...
          <div class="col-md-4 mb-4">
            <div class="card">
              <div class="card-body">
                ...
                <div style="height: 300px;">
                  <canvas #interviewTypeChart id="interviewTypeChart"></canvas>
                </div>
              </div>
            </div>
          </div>
      ...
      <div *ngIf="activeTab === 'transactions'">
        <div class="card">
          <div class="card-body">
            ...
            <p class="text-muted small mb-4">Your most recent earnings from interviews</p>
...
export class EarningsComponent implements AfterViewInit {
  ...
  initInterviewTypeChart() {
    ...
    new Chart(ctx, {
      type: "bar",
      data: {
        labels: ["Behavioral", "Technical", "System Design", "Pair Programming"],
        datasets: [
          {
